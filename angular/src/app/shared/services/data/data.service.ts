...
import { Booking, Car, User, header } from '../model/model';
...
export class DataService {
  ...
  public header: header[] = [
    ...
    },
    {
      ...
      // menu: [
      //   {
      //     menuValue: 'Afficher La  liste des voitures',
      //     routes: routes.listingList,
      //     hasSubRoute: false,
      //     showSubRoute: false,
      //     subMenus: [],
  ...
  public owner= {
    phoneNumber : "+212 6 06 89 24 22",
    email : "seekechcar@gmail.com"
  }
  ...
  private carSource = new BehaviorSubject<Car>(new Car());
  ...
  private isLoggedIn = new BehaviorSubject<boolean>(this.authService.loggedIn);
  isLogged = this.isLoggedIn.asObservable();
  changeUser(logged: boolean){
    this.isLoggedIn.next(logged);
    console.log("user changed" + logged);
  }
}